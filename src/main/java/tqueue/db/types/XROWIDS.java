...
public class XROWIDS implements ORAData, ORADataFactory, java.io.Serializable
{
  public static final String _SQL_NAME = "TQREACTOR.XROWIDS";
  public static final int _SQL_TYPECODE = OracleTypes.ARRAY;

  transient MutableArray _array;

private static final XROWIDS _XROWIDSFactory = new XROWIDS();

  public static ORADataFactory getORADataFactory()
  { return _XROWIDSFactory; }
  /* constructors */
  public XROWIDS()
  {
    this((String[])null);
  ...
  { try { String r = "TQREACTOR.XROWIDS" + "(";
