...
--=========================================================================  
  ...
  FUNCTION MAKE_SPEC(threadMod IN PLS_INTEGER, batchLimit IN INT DEFAULT 32, rowLimit IN PLS_INTEGER DEFAULT 2147483647, threadCount IN PLS_INTEGER DEFAULT 8, cpuMulti INT DEFAULT 1, waitLoops IN INT DEFAULT 2, waitSleep IN NUMBER DEFAULT 1) RETURN BATCH_SPEC;
