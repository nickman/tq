...
--=========================================================================  
  ...
  FUNCTION MAKE_SPEC(threadMod IN PLS_INTEGER, rowLimit IN PLS_INTEGER DEFAULT 1024, threadCount IN PLS_INTEGER DEFAULT 16, cpuMulti INT DEFAULT 1, waitLoops IN INT DEFAULT 2, waitSleep IN NUMBER DEFAULT 1, bucketSize IN PLS_INTEGER DEFAULT 999999) RETURN BATCH_SPEC;
  
  FUNCTION GROUP_BATCH_STUBS(spec IN BATCH_SPEC DEFAULT DEFAULT_SPEC) RETURN TQBATCH_ARR PIPELINED;
